...
set rc [catch {
  ...
  set_property ip_repo_paths d:/Ray/Vivado/CPU54/CPU54.cache/ip [current_project]
  set_property ip_output_repo d:/Ray/Vivado/CPU54/CPU54.cache/ip [current_project]
  add_files -quiet D:/Ray/Vivado/CPU54/CPU54.runs/synth_1/sccomp_dataflow.dcp
  add_files -quiet d:/Ray/Vivado/CPU54/CPU54.srcs/sources_1/ip/imem/imem.dcp
  set_property netlist_only true [get_files d:/Ray/Vivado/CPU54/CPU54.srcs/sources_1/ip/imem/imem.dcp]
  read_xdc -mode out_of_context -ref imem -cells U0 d:/Ray/Vivado/CPU54/CPU54.srcs/sources_1/ip/imem/imem_ooc.xdc
  set_property processing_order EARLY [get_files d:/Ray/Vivado/CPU54/CPU54.srcs/sources_1/ip/imem/imem_ooc.xdc]
  ...
  link_design -top sccomp_dataflow -part xc7a75tcsg324-1
